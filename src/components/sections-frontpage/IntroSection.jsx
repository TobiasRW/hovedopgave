    ...
    return (
        <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-20 pt-16 lg:pt-20">
            <div className="flex flex-col items-center gap-4 md:gap-8 lg:gap-10">
                ...
                <p className=" w-4/5 xl:w-[1150px] text-sm sm:text-base xl:text-lg font-light leading-normal text-black "><span className="font-normal italic">Af rosacea-ramte til rosacea-ramte.</span> Cølm er et 100% dansk brand grundlagt som følge af hudlidelsen, rosacea, som rammer mellem 5-10% af alle danskere - inklusiv brandets stiftere. Hos cølm er vi dedikerede til at levere effektive resultater mod hudproblemer som rosacea, perioral dermatitis og akne. <a href="#" className="underline text-blue font-normal italic">Læs mere...</a></p>
            </div>
            <div className="">
                <Services />
            </div>
